...
class ProfileService {
  ...
  static Future<SmaylProfile?> getProfileById (String id) async {
    final backendResponse = await get(Uri.parse("http://172.16.1.19:8080/profile/${id}"));
  ...
  static Future<bool?> createProfileInBackend(User user, String firstName, String lastName, String emailAddress, String studyGroup, SmaylProfileType profileType, bool administrative) {
    ...
    post(Uri.parse("http://172.16.1.19:8080/profile/create"), jsonEncode(profile)));
  }
}